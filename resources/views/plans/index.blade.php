            ...
            <div class="row no-margin text-center">
                ...
                <div class="add-top-6 xs-add-top-4">
                    ...
                    <ul class="nav nav-tabs" id="chooseDeviceTab" role="tablist">
                        <li role="presentation" class='active data-button'><a href="#data" aria-controls="data" role="tab" data-toggle="tab">Data</a></li>
                        <li role="presentation" class="voice-button"><a href="#voice" aria-controls="voice" role="tab" data-toggle="tab">Voice</a></li>
                    </ul>
                    <!-- Tab panes -->
...
@push('js')
    <script>
        $("document").ready(function() {
            ...
            if(selectedplan === parseInt(selectedplan, 10)) {
                setTimeout(function () {
